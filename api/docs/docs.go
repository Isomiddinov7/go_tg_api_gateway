...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/premium/price/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdatePriceCoin",
                        "name": "profile",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/coins_service.UpdatePrice"
                        }
                    }
                ],
                "responses": {
        ...
        "/user": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "UpdateUserStatusBody",
                        "name": "profile",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users_service.UpdateUserStatus"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Update User Status Body",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/http.Response"
    ...
    "definitions": {
        ...
        "users_service.UpdateUserStatus": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string"
