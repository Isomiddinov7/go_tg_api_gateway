    ...
    "paths": {
        ...
        "/user/buy": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "UserBuyBody",
                        "name": "profile",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users_service.UserBuyRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/user/image/buy/{id}": {
            "get": {
                ...
                "operationId": "get_user_buy_file_url",
                "parameters": [
                    {
                        "type": "string",
        ...
        "/user/image/sell": {
            "post": {
                ...
                "operationId": "UploadUserSellFile",
                "parameters": [
                    {
                        "type": "file",
                        "description": "Upload file",
        ...
        "/user/image/sell/{id}": {
            "get": {
                ...
                "operationId": "get_user_sell_file_url",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Image ID",
        ...
        "/user/sell": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "UserSellBody",
                        "name": "profile",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/users_service.UserSellRequest"
                        }
                    }
                ],
                "responses": {
